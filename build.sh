...
if [ $KSU_ENABLE -eq 1 ]; then
    echo "KSU is enabled"
    curl -LSs "https://ghp.ci/raw.githubusercontent.com/tiann/KernelSU/main/kernel/setup.sh" | bash -s v0.9.5
else
...
git clone https://ghp.ci/github.com/liyafe1997/AnyKernel3 -b kona --single-branch --depth=1 anykernel
